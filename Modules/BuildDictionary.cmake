...
function ( build_dictionary )
  ...
  if( NOT BD_NO_INSTALL )
    ...
    install ( TARGETS ${dictname}_dict DESTINATION ${CMAKE_INSTALL_LIBDIR})
    # add to library list for package configure file
    #cet_add_to_library_list( ${dictname}_dict )
    if (BD_WANT_CAP_FILE)
      install ( TARGETS ${dictname}_map DESTINATION ${CMAKE_INSTALL_LIBDIR})
    endif()
    if (BD_WANT_ROOTMAP)
      install ( FILES ${ROOTMAP_OUTPUT} DESTINATION ${CMAKE_INSTALL_LIBDIR})
    endif()
    if (PCM_OUTPUT)
      install ( FILES ${PCM_OUTPUT} DESTINATION ${CMAKE_INSTALL_LIBDIR})
    endif()
  endif()
